...
export const fetchPartcipants = tryCatchAction(
  async (): Promise<ActionResponse<ParticipantsWithUser[]>> => {
    const data = await db
      .select({
...
export const fetchTotalUsers = tryCatchAction(
...
export const fetchParticipantById = tryCatchAction(
  async (id: string): Promise<ActionResponse<Participants>> => {
    const data = await db
      .select()
      .from(participants)
...
export const fetchUserById = tryCatchAction(
...
export const fetchAdminStats = tryCatchAction(
  async (): Promise<
    ActionResponse<{
      totalUsers: number;
...
export const fetchAdminChartData = tryCatchAction(
  async (): Promise<
    ActionResponse<{
...
export const fetchSubmissionsByUserId = tryCatchAction(
  async (userId: string): Promise<ActionResponse<Submission[]>> => {
    const data = await db
      .select()
      .from(submissions)
